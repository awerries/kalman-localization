...
plot(filter_time, rad2deg(ground_truth_full(:,4)),'--r');
xlabel('Time (s)');
ylabel('Roll (deg)');
legend('Filter','Applanix');

subplot(312);
plot(filter_time, rad2deg(pitch)); hold on;
plot(filter_time, rad2deg(ground_truth_full(:,5)),'--r');
xlabel('Time (s)');
ylabel('Pitch (deg)');
subplot(313);
plot(filter_time, rad2deg(yaw)); hold on;
plot(filter_time, rad2deg(ground_truth_full(:,6)),'--r');
xlabel('Time (s)');
ylabel('Yaw (deg)');
