...
figurec;
plot(pos_sd_min, max_error_filter); hold on;
plot(pos_sd_min, rms_error_filter);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% pos_sd_max = linspace(10,200,500);
